...
func (z *AddressBook) EncodeMsg(en *msgp.Writer) (err error) {
	...
	if (zb0001Mask & 0x100000000) == 0 { // if not omitted
		// write "35949258"
	...
	if (zb0001Mask & 0x400000000) == 0 { // if not omitted
		// write "65532258"
	...
	if (zb0001Mask & 0x800000000) == 0 { // if not omitted
		// write "3598531"
	...
	if (zb0001Mask & 0x1000000000) == 0 { // if not omitted
		// write "3598431"
	...
	if (zb0001Mask & 0x2000000000) == 0 { // if not omitted
		// write "3598631"
	...
	if (zb0001Mask & 0x4000000000) == 0 { // if not omitted
		// write "3598231"
	...
	if (zb0001Mask & 0x8000000000) == 0 { // if not omitted
		// write "3598331"
	...
	if (zb0001Mask & 0x10000000000) == 0 { // if not omitted
		// write "20553"
	...
	if (zb0001Mask & 0x20000000000) == 0 { // if not omitted
		// write "205731"
	...
	if (zb0001Mask & 0x40000000000) == 0 { // if not omitted
		// write "360003"
	...
	if (zb0001Mask & 0x80000000000) == 0 { // if not omitted
		// write "3278531"
	...
	if (zb0001Mask & 0x100000000000) == 0 { // if not omitted
		// write "1383631"
	...
	if (zb0001Mask & 0x200000000000) == 0 { // if not omitted
		// write "138243"
	...
	if (zb0001Mask & 0x400000000000) == 0 { // if not omitted
		// write "145923"
	...
	if (zb0001Mask & 0x800000000000) == 0 { // if not omitted
		// write "145973"
	...
	if (zb0001Mask & 0x1000000000000) == 0 { // if not omitted
		// write "4258"
	...
	if (zb0001Mask & 0x2000000000000) == 0 { // if not omitted
		// write "36034258"
	...
	if (zb0001Mask & 0x4000000000000) == 0 { // if not omitted
		// write "1258"
	...
	if (zb0001Mask & 0x8000000000000) == 0 { // if not omitted
		// write "14594258"
	...
	if (zb0001Mask & 0x10000000000000) == 0 { // if not omitted
		// write "35998258"
