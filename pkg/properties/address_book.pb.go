...
type AddressBook struct {
	...
	// Contains the phonetic representation of the PidTagCompanyName property (section 2.640).
	...
	// Contains the phonetic representation of the PidTagDepartmentName property (section 2.673).
	...
	// Contains the phonetic representation of the PidTagDisplayName property (section 2.677).
	...
	// Contains the phonetic representation of the PidTagGivenName property (section 2.715).
	...
	// Contains the phonetic representation of the PidTagSurname property (section 2.1037).
	...
	// Contains the value of the PidTagEntryId property (section 2.684), expressed as a Permanent Entry ID format.
...
var file_address_book_proto_rawDesc = []byte{
	...
	0x6e, 0x61, 0x69, 0x6c, 0x5f, 0x70, 0x68, 0x6f, 0x74, 0x6f, 0x42, 0x25, 0x5a, 0x23, 0x67, 0x69,
	0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x41, 0x6e, 0x74, 0x65, 0x69, 0x69, 0x2f,
...
func file_address_book_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_address_book_proto_msgTypes[0].Exporter = func(v any, i int) any {
	...
	file_address_book_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
