...
type Contact struct {
	...
	// Contains the same value as the PidTagNormalizedSubject property (section 2.813).
...
var file_contact_proto_rawDesc = []byte{
	...
	0x41, 0x6e, 0x74, 0x65, 0x69, 0x69, 0x2f, 0x67, 0x6f, 0x2d, 0x70, 0x73, 0x74, 0x3b, 0x70, 0x72,
...
func file_contact_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_contact_proto_msgTypes[0].Exporter = func(v any, i int) any {
