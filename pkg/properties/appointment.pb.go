...
type Appointment struct {
	...
	// Indicates whether the value of the PidLidLocation property (section 2.159) is set to the PidTagDisplayName property (section 2.677).
...
var file_appointment_proto_rawDesc = []byte{
	...
	0x65, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x42, 0x25, 0x5a, 0x23, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
	0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x41, 0x6e, 0x74, 0x65, 0x69, 0x69, 0x2f, 0x67, 0x6f, 0x2d, 0x70,
...
func file_appointment_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_appointment_proto_msgTypes[0].Exporter = func(v any, i int) any {
	...
	file_appointment_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
