...
var file_extracted_entity_proto_rawDesc = []byte{
	...
	0x72, 0x61, 0x63, 0x74, 0x65, 0x64, 0x5f, 0x75, 0x72, 0x6c, 0x73, 0x42, 0x25, 0x5a, 0x23, 0x67,
	0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x41, 0x6e, 0x74, 0x65, 0x69, 0x69,
...
var file_extracted_entity_proto_goTypes = []any{
...
func file_extracted_entity_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_extracted_entity_proto_msgTypes[0].Exporter = func(v any, i int) any {
	...
	file_extracted_entity_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
